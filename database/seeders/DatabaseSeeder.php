    ...
    public function run(): void
    {
        ...
        foreach ($employees as $employeeIndex => $employee) {
            ...
            for ($i = 7; $i >= 1; $i--) {
                ...
                // Make some records "problematic" (forgot to clock out)
                // Let's say employee 1 and 2 forgot to clock out on specific days
                $isProblematic = ($employeeIndex < 2 && $i === 2); 
                ...
                if ($isProblematic) {
                    DailyAttendance::create([
                        ...
                        'notes' => 'Sistem: Belum melakukan absen pulang.',
                    ]);

                    // No salary record yet for problematic attendance
                } else {
                ...
                // Create Log for Check-in (always exists)
